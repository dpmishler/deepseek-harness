...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/speech/speech': { kind: 'none', reason: 'The STT/TTS provider registry only opens sessions and forwards audio/text; no model-facing consumer is registered yet.' },
  'packages/speech/speech-deepgram-flux-stt': { kind: 'none', reason: 'The Deepgram Flux STT adapter only opens sessions; no model-facing consumer is registered yet.' },
  'packages/speech/speech-deepgram-flux-tts': { kind: 'none', reason: 'The Deepgram Flux TTS adapter only opens sessions; no model-facing consumer is registered yet.' },
