...
| `ctx.speech` | `seam` | [`speech`](../packages/speech/speech) | [`speech-deepgram-flux-stt`](../packages/speech/speech-deepgram-flux-stt), [`speech-deepgram-flux-tts`](../packages/speech/speech-deepgram-flux-tts) | [`speech-agent`](../packages/speech/speech-agent) | - | STT/TTS providers register into one ctx.speech seam by explicit id (no auto-selection); speech-agent's TurnController is the sole Consumer, correlating both directions into one barge-in-aware conversation. |
