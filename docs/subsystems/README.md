...
| [voice.md](voice.md) | the voice capability seam: `SttSession`/`TtsSession`, `SttEvent`/`TtsEvent` variants, `SttProvider`/`TtsProvider` interfaces, `VoiceError` codes, Deepgram Flux STT and TTS wire protocol |
