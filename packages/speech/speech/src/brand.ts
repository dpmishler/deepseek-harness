/**
 * dsh-speech's owned branded ids: cross-boundary correlation identifiers for
 ...
 * brand it without depending on dsh-speech; see that package's README for the
 * nominal-typing policy.
 *
 * @module @deepseek-ai/dsh-speech/brand
 */
...
/** Provider-assigned identifier for one TTS turn within an open session. */
