...
| [`speech/`](speech/README.md) | Speech capability family: seam, Deepgram Flux STT/TTS provider adapters, and a speech-agent orchestration Consumer (no model-facing tool yet) | Foundation — POC |
