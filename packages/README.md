...
| [`speech/`](speech/README.md) | Speech capability family: seam, Deepgram Flux STT/TTS provider adapters, and the barge-in turn-controller Consumer | Foundation — POC |
